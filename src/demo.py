...
def live_demo(y: np.ndarray, times: np.ndarray,probs_all: np.ndarray, stems, threshold: float):
...
def main():
    ...
    parser.add_argument("--model", default="runs/cnn_baseline/best_model.pt")
